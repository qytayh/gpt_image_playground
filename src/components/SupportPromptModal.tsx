      ...
      >
        ...
        <div className="flex items-center justify-center">
          <a
            ...
            onClick={dismissSupportPrompt}
            className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-2xl bg-[#946ce6] px-5 py-3.5 text-[15px] font-semibold text-white transition-all hover:bg-[#8358dc] active:scale-[0.98] dark:bg-[#946ce6] dark:hover:bg-[#a885ee]"
          >
